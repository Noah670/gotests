...
go tests are generated from the source file and the method signatures. All of the dependencies can be installed or imported from the file automatically.
`gotests` can also be shown using the VSCode plugin at [Visual Studio Code](https://github.com/Microsoft/vscode-go)
